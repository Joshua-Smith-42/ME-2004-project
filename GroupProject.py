...
plt.plot(positionsConstantV, carConstantV.velocities, "v-", label="constant velocity (m/s)")
plt.plot(positionsConstantV, carConstantV.accelerations, "o-", label="acceleration for constant velocity (m/s^2)")
plt.plot(positionsVariableV, carVariableV.velocities, "v-", label= "changing velocties (m/s)")
plt.plot(positionsVariableV, carVariableV.accelerations, "o-", label= "accelerations for variable velocities (m/s^2)")
